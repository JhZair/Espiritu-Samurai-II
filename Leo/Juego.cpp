...
Juego::Juego()
    : window(sf::VideoMode(1920, 1080), "Peleitas"), 
    //   piso(660.0f, 750.0f, 120f, 350.0f), 
      piso(0.0f, 750.0f, 1200.0f, 350.0f), 
      tiempoDelta(0.0f), 
      tiempoPartida(90.0f), 
...
{
    jugador1 = new Hanzo(375.0f, 450.0f, sf::Color::Yellow);
